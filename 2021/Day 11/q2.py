...
steps_to_simulate = 382  # part 2 solved just by changing this number manually
# NOTE : could automate this by looping over the grid after each iteration in a while loop and when every value is 0, stop and print
flashes_count = 0
